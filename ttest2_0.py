...
def draw_all(win,color_grass, color_sky, b_height, b_width, color_sun,x ,y, k, bool_truba, bool_smoke, color_roof, color_door, color_door1, color_house, color_truba1, color_truba2, color_window, color_door_hand,
	...
	draw_cloud(win, x_cloud, y_cloud, k_cloud, color_cloud)
"""
b_height = 1280
b_width = 1600
color_sky = "#368EFF"
...
draw_all(win,color_grass = '#28A642', color_sky = "#388fFF", b_height = 1280, b_width = 1600, color_sun = 'yellow', x = 340, y = 450, k = 1.3, bool_truba = True, bool_smoke = True, color_roof = "#D33D25", color_door = "#89551B", color_door1 = 'brown',
	color_house = "#F09838", color_truba1 = "#8A551C", color_truba2 = "#8A551C", color_window = "#4294F7", color_door_hand = "yellow", x_cloud = 150, y_cloud = 150, k_cloud = 0.85, color_cloud = 'white',
